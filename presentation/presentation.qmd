...
```
:::{.notes}
In his map we try to encapsulate info about not only how good is the pubs rating, but also how many ratings the pub has.
This 
:::
## Praguea ratings
...
## Prague - best and worst

```{python}
print_min_max_rating_filtered(prague_pubs_df,1)
```

## Prague - best and worst without outliers
...
## Czechia - best and worst

```{python}
print_min_max_rating_filtered(czech_pubs_df,1)
```

## Czechia - best and worst without outliers
